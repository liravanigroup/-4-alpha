...
public class Resolution implements Cloneable{
    ...
    public Resolution(int widthImage, int heightImage, double price) {
        ...
        for (String s : manualPrices) {
            ...
            switch (manualParam[0]) {
                case "S":
                    ...
                    resolutions.add(new Resolution(sm[0],sm[1],manualPrice));
                    break;
                case "M":
                    int[] m = resizeToM(width,height);
                    resolutions.add(new Resolution(m[0],m[1],manualPrice));
                    break;
                case "L":
                    int[] l = resizeToL(width,height);
                    resolutions.add(new Resolution(l[0],l[1],manualPrice));
                    break;
                case "XL":
                    int[] xl = resizeToXL(width,height);
                    resolutions.add(new Resolution(xl[0],xl[1],manualPrice));
                    break;
                case "XXL":
                    int[] xxl = resizeTo2XL(width,height);
                    resolutions.add(new Resolution(xxl[0],xxl[1],manualPrice));
                    break;
                case "XXXL":
                    int[] xxxl = resizeTo3XL(width,height);
                    resolutions.add(new Resolution(xxxl[0],xxxl[1],manualPrice));
                    break;
            }
        }
       return resolutions;
